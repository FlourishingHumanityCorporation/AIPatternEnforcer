...
describe('TestMigrationComponent', () => {
  ...
  it('applies custom className', () => {
    const { container } = render(<TestMigrationComponent className="custom-class">Content</TestMigrationComponent>);
    expect(container.firstChild).toHaveClass('custom-class');
  });

  it('handles click events', () => {
    const handleClick = vi.fn();
    render(<TestMigrationComponent onClick={handleClick}>Clickable</TestMigrationComponent>);
  ...
  it('does not handle keyboard events when not clickable', () => {
    const { container } = render(<TestMigrationComponent>Not Clickable</TestMigrationComponent>);
